...
if not ue_excel_loader_include_rule:
  ue_excel_loader_include_rule = pb_set.get_custom_variable("ue_include_prefix", "ExcelLoader") + "/%(file_path_without_ext)s.h"
...
#include "${ue_excel_loader_include_rule % message_include_format_args}"
%   endif
% endfor
